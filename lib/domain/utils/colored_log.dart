...
class CLog {
  ...
  void grey(String text) {
    final color = _getRGBColor(r: 128, g: 128, b: 128);
    if (kDebugMode) {
  ...
  void red(String text) {
    final color = _getRGBColor(r: 255, g: 0, b: 0);
    if (kDebugMode) {
      print('\x1B[38;5;${color}m' + text + '\x1B[0m');
    }
  }
  ...
  void green(String text) {
    final color = _getRGBColor(r: 0, g: 255, b: 0);
    if (kDebugMode) {
      print('\x1B[38;5;${color}m' + text + '\x1B[0m');
    }
  }
  ...
  void blue(String text) {
    final color = _getRGBColor(r: 0, g: 0, b: 255);
    if (kDebugMode) {
      print('\x1B[38;5;${color}m' + text + '\x1B[0m');
    }
  }
